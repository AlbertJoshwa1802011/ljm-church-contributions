// Regression test: v2/events.html, v2/index.html, and v2/blog.html each
// hard-truncated a long description/body with a plain `.slice(0, N)` and no
// ellipsis or word-boundary check. Real seeded content hit this: the VBS
// 2026 event description is longer than 110 chars and the cut landed mid-
// word ("...Three days of B"), on both the Events page and the Home page's
// "Upcoming" card.
//
// Each of the three pages now defines a `truncate(s, limit)` helper that
